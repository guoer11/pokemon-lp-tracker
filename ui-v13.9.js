...
function compactAuth(){
  const auth=$('.auth');
  if(!auth||auth.dataset.v139==='1')return;
  auth.dataset.v139='1';
...
const leagueMap={
  '超級球':'league-great-v139',
  '紀念球':'league-premier-v139',
  '高級球':'league-ultra-v139',
  '大師球':'league-master-v139',
  '世界賽':'league-world-v139'
};
...
function decorateCard(card){
  ...
  badges.querySelectorAll('.bestbadge,.top8badge-v137,.placement-badge-v138,.placement-badge-v139').forEach(x=>x.remove());
  [...badges.querySelectorAll('.badge')].forEach(b=>{
    const text=b.textContent.trim();
    for(const [name,cls] of Object.entries(leagueMap))if(text===name){
      b.classList.remove('league-great-v137','league-premier-v137','league-ultra-v137','league-master-v137','league-world-v137','league-great-v138','league-premier-v138','league-ultra-v138','league-master-v138','league-world-v138');
  ...
  if(info){
    ...
    top.className='badge placement-badge-v139 '+info.cls;
